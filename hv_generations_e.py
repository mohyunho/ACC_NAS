...
ea_log_path = os.path.join(current_dir, 'EA_log_e')
...
plt.xlim(0,11)
fig_verify.savefig(os.path.join(pic_dir, 'hv_plot_full_%s_%s.png' % (pop_size, n_generations)), dpi=1500,
                   bbox_inches='tight')
fig_verify.savefig(os.path.join(pic_dir, 'hv_plot_full_%s_%s.eps' % (pop_size, n_generations)), dpi=1500,
                   bbox_inches='tight')

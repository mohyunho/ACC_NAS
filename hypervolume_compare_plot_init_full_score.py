...
################### pareto front plot ###############
    ...
    fig.savefig(os.path.join(pic_dir, 'infer_prft_val_comparison_score_init_full_%s_%s_%s_%s.png' % ( pop_size, n_generations, trial, ep)), dpi=1500, bbox_inches='tight')
...
##############################################
    ...
    ax.scatter(prft_ori_full_rmse, prft_ori_full_params, facecolor=(0.4, 0.1, 0.6),
               edgecolors=(0.0, 0.0, 0.0), zorder=1, s=30,  label="Training 30 ep. , HV: %s" %result_ori_full_test)    
    ...
    ax.scatter(prft_score_rmse, prft_score_params, facecolor=(0.9, 0.5, 0.8),
               edgecolors=(0.0, 0.0, 0.0), zorder=1, s=40,  label="Architecture score, HV: %s" %result_score_test)

    ax.scatter(prft_ori_init_rmse, prft_ori_init_params, facecolor=(1.0, 0.8, 0.1),
               edgecolors=(0.0, 0.0, 0.0), zorder=2, s=30,  label="Initial population, HV: %s" %result_ori_init_test)    
    ...
    # Save figure
    # ax.set_rasterized(True)
    fig.savefig(os.path.join(pic_dir, 'infer_prft_test_comparison_score_init_full_%s_%s_%s_%s.png' % (pop_size, n_generations, trial, ep)), dpi=1500, bbox_inches='tight')

...
################### pareto front plot ###############
    ...
    fig.savefig(os.path.join(pic_dir, 'infer_prft_val_comparison_score_init_%s_%s_%s_%s.png' % ( pop_size, n_generations, trial, ep)), dpi=1500, bbox_inches='tight')
...
##############################################
    ...
    # Save figure
    # ax.set_rasterized(True)
    fig.savefig(os.path.join(pic_dir, 'infer_prft_test_comparison_score_init_%s_%s_%s_%s.png' % (pop_size, n_generations, trial, ep)), dpi=1500, bbox_inches='tight')

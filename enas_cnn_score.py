...
from utils.score_cnn_task import SimpleNeuroEvolutionTask
from utils.score_ea_multi import GeneticAlgorithm
...
def main():
    ...
    if obj == "soo":
        ...
        mutate_log_path = 'EA_log/mute_log_score_%s_%s_%s_%s_%s.csv' % (pop_size, n_generations, obj, trial, ep)
    ...
    prft_path = os.path.join(directory_path, 'prft_out_score_%s_%s_%s_%s.csv' % (pop_size, n_generations, trial,ep))

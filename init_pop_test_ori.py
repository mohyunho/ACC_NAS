...
def main():
    ...
    log_filename = 'mute_log_%s_%s_%s_%s_%s_%s.csv'  %(ablation, pop_size, n_generations, obj, trial, ep)
    ...
    output_filepath = os.path.join(log_dir_path, 'inference_prft_%s_%s_0_%s_%s_%s.csv' % (ablation, pop_size, obj, trial, ep))

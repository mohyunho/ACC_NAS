...
################### pareto front plot ###############
    ...
    fig.savefig(os.path.join(pic_dir, 'infer_prft_val_comparison_score_init_combined_%s_%s_%s_%s.png' % ( pop_size, n_generations, trial, ep)), dpi=1500, bbox_inches='tight')
...
##############################################
    ...
    ax.scatter(prft_combined_rmse, prft_combined_params, facecolor=(1.0, 1.0, 0.4),
               edgecolors=(0.0, 0.0, 0.0), zorder=3, s=40,  label="Architecture score w. extrapolation, HV: %s" %result_combined_test)
    ...
    # Save figure
    # ax.set_rasterized(True)
    fig.savefig(os.path.join(pic_dir, 'infer_prft_test_comparison_score_init_combined_%s_%s_%s_%s.png' % (pop_size, n_generations, trial, ep)), dpi=1500, bbox_inches='tight')

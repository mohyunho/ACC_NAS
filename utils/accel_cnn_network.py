...
class network_fit(object):
    ...
    def __init__(self, sample_array, n_layers,
                 n_filters, kernel_size, n_mlp, batch, ob_ep, epoch, patience, val_split, model_path, device):
        '''
        Constructor
    ...
    def train_net(self, model, lr, geno_lst, train_sample_array, train_label_array, val_sample_array, val_label_array):
        ...
        for index, (key, value) in enumerate(all_models.items()):
            ...
            elif key== "logistic_curve":
                fitting_parameters, covariance = curve_fit(value, x_observation, y_obesrvation, p0=[15,4,10,20], maxfev=10000000)
            elif key == "pow3":

...
def main():
    ...
    fig.savefig(os.path.join(pic_dir, 'prft_testRMSE-score_%s_%s.png' % (pop_size, n_generations)), dpi=1500, bbox_inches='tight')
    fig.savefig(os.path.join(pic_dir, 'prft_testRMSE-score_%s_%s.eps' % (pop_size, n_generations)), dpi=1500, bbox_inches='tight')
    fig.savefig(os.path.join(pic_dir, 'prft_testRMSE-score_%s_%s.pdf' % (pop_size, n_generations)), bbox_inches='tight')

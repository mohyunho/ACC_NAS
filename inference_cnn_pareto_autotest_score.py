...
def main():
    ...
    prft_filename = 'prft_out_score_%s_%s_%s_%s.csv'  %(pop_size, n_generations, trial, ep)
    ...
    output_filepath = os.path.join(log_dir_path, 'inference_prft_score_%s_%s_%s_%s_%s.csv' % (pop_size, n_generations, obj, trial, ep))

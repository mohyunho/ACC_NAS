...
def main():
    ...
    parser.add_argument('--pop', type=int, default=30, required=False, help='population size of EA')
    parser.add_argument('--gen', type=int, default=30, required=False, help='generations of evolution')
